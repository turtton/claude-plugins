...
Claude Code の品質・生産性を向上させるプラグインコレクション。
...
plan mode で作成された実装プランをエージェントが批判的にレビューするスキル。
review-gate とは独立したプラグインであり、単体で利用可能。

プランを5つの観点（目的との整合性、変更対象の網羅性、コードベースとの整合性、過剰設計、リスク・副作用）でレビューし、コードベースを実際に確認した上で事実に基づく指摘を行う。
